...
public class MiguelApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Checking checking1 = checkingService.createChecking(new CreateCheckingDTO(500d, 5l, null, LocalDate.now(), Status.ACTIVE, "12345", LocalDate.now(), 10, 100));
		Creditcard credit1 = creditcardService.createCreditcard(new CreateCreditCardDTO(1500, 7l, null, LocalDate.now(), Status.ACTIVE, "12345", LocalDate.now(), 1000, 0.2));
		Savings savings1 = savingsService.createSavings(new CreateSavingsDTO(2500, 9l, null, LocalDate.now(), Status.ACTIVE, "12345", LocalDate.now(), 0.0025, 500));
		StudentChecking student1 = studentService.createStudent(new CreateStudentDTO(3500, 11l, null, LocalDate.now(), Status.ACTIVE, "12345", LocalDate.now()));
